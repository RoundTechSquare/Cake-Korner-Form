...
<head>
    ...
    <title>Newsletter Subscriptions | Cake Korner</title>
                ...
                <div class="page-content is-relative">
                    ...
                    <div class="page-title has-text-centered">
                        ...
                        <div class="title-wrap">
                            <h1 class="title is-4">Newsletter Subscriptions</h1>
                        </div>
                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="table-wrapper" data-simplebar>
                            <table id="contactform-table" class="table is-datatable is-hoverable table-is-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT `email` FROM `newsletter_subscriptions` WHERE 1";
