                ...
                <div class="container">
                    <div class="gallery-outer-wrap mt-5">
                                ...
                                <div class="single-gallery grid-item">
                                    <figure class="gallery-img">
                                        <a href="./assets/images/gallery-two/CupCake/cupcake-<?= $i ?>.jpg" data-fancybox="gallery">
                                            <img src="./assets/images/gallery-two/CupCake/cupcake-<?= $i ?>.png" style="border-radius: 10px;" alt="Cake Korner Gallery Dessert" />
                        ...
                        <div class="view-more-button ">
                            <button type="button" class="view-more" onclick='loadDiv()' style="border-radius: 5px">VIEW MORE</button>
                        </div>
                    </div>
