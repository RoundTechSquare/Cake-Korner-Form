                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="signup_form row">
                                        ...
                                        ?>
                                                <div class="form-group col-lg-3">
                                                    <div class="d-flex align-items-center">
                                                        <input type="radio" class="form-control checkbox-02" name="cakeShape" onclick="$('#otherDiv').css('opacity','0');$('#cakeShapeCustom').val('-');" id="cakeSheet<?= $row['id'] ?>" value="<?= $row['id'] ?>" onchange="$('#cakeSizeType').val('squareCake')">
                                    ...
                                    <div class="row ml-0">
                                        ...
                                        ?>
                                                <div class="form-group col-lg-4">
                                                    <div class="d-flex align-items-center">
                                                        <input type="radio" class="form-control checkbox-02" name="cakeShape" onclick="$('#otherDiv').css('opacity','0');$('#cakeShapeCustom').val('-');" id="cakeSize<?= $row['id'] ?>" value="<?= $row['id'] ?>" onchange="$('#cakeSizeType').val('roundCake')">
                                    ...
                                    <div class="row ml-0">
                                        <div class="form-group col-lg-7">
                                            <div class="d-flex align-items-center">
                                                <input type="radio" class="form-control checkbox-02 cakeShapeCustom" onclick="$('#otherDiv').css('opacity','100')" name="cakeShape" id="cakeShapeCustom" value="0">
                                                <p class="round-cake-select">Customized Size Option</p>
                                            </div>

                                        </div>
                                        <div class="form-group col-lg-5" id="otherDiv" style="opacity:0;">
                                            <input type="text" class="form-control" id="otherOptionShape" onchange="$('#cakeShapeCustom').val(this.value);if(this.value != ''){$('#cakeSizeType').val('other');}" placeholder="Enter Custom Size">
                                        </div>
                                    </div>
                                    ...
                                    <div id="vegetarian" class="row ml-0">
                                        ...
                                        <div id="innerCream" class="col-lg-12" style="display:block">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="form-group col-lg-4" style="display:flex;margin-top:5px">
                                                            <input style="width:20px; height:20px; margin-right:10px" type="radio" onclick="$('#vegetarianFlavorsType').val('regular');$('#otherDivFlavor').css('opacity','0');$('#cakeFlavorCustom').val('-');" name="cakeFlavors" value="<?= $row['id'] ?>" class="form-control vegetarianFlavors" id="vegetarianFlavorsRegular-<?= $row['id'] ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="form-group col-lg-4" style="display:flex;margin-top:5px">
                                                            <input style="width:20px;height:20px;margin-right:10px" type="radio" name="cakeFlavors" onclick="$('#vegetarianFlavorsType').val('special');$('#otherDivFlavor').css('opacity','0');$('#cakeFlavorCustom').val('-');" value="<?= $row['id'] ?>" class="form-control vegetarianFlavors" id="vegetarianFlavorsSpecial-<?= $row['id'] ?>"><label class="input_title" for="vegetarianFlavorsSpecial-<?= $row['id'] ?>"><?= $row['name'] ?></label>
                                                        </div>
                                                <?php $i++;
                                                    }
                                                }
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="form-group col-lg-3" style="display:flex;margin-top:5px">
                                                            <input style="width:20px;height:20px;margin-right:10px" type="radio" onclick="$('#vegetarianFlavorsType').val('-');$('#otherDivFlavor').css('opacity','0');$('#cakeFlavorCustom').val('-');" name="cakeFlavors" class="form-control veganFlavors" value="<?= $row['id'] ?>" id="veganFlavors-<?= $row['id'] ?>"><label class="input_title" for="veganFlavors-<?= $row['id'] ?>"><?= $row['name'] ?></label>
                                                        </div>
                                                <?php $i++;
                                                    }
                                                }
                                    ...
                                    <div id="specialCake" class="row ml-0">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row" style="margin-left: 5px;">
                                                ...
                                                ?>
                                                        <div class="form-group col-lg-3" style="display:flex;margin-top:5px">
                                                            <input style="width:20px;height:20px;margin-right:10px" type="radio" onclick="$('#vegetarianFlavorsType').val('-');$('#otherDivFlavor').css('opacity','0');$('#cakeFlavorCustom').val('-');" name="cakeFlavors" class="form-control sugarFreeFlavors" value="<?= $row['id'] ?>" id="sugarFreeFlavors-<?= $row['id'] ?>"><label class="input_title" for="sugarFreeFlavors-<?= $row['id'] ?>"><?= $row['name'] ?></label>
                                                        </div>
                                                <?php $i++;
                                                    }
                                                }
                                    ...
                                    <div class="row ml-0">
                                        <div class="form-group col-lg-7">
                                            <div class="d-flex align-items-center">
                                                <input type="radio" class="form-control checkbox-02 cakeFlavorCustom" onclick="$('#otherDivFlavor').css('opacity','100');$('#vegetarianFlavorsType').val('custom')" name="cakeFlavors" id="cakeFlavorCustom" value="-">
                                                <p class="round-cake-select">Customized Flavor Option</p>
                                            </div>

                                        </div>
                                        <div class="form-group col-lg-5" id="otherDivFlavor" style="opacity:0;">
                                            <input type="text" class="form-control" id="otherOptionFlavor" onchange="$('#cakeFlavorCustom').val(this.value);if(this.value != ''){$('#vegetarianFlavorsType').val(other);}" placeholder="Enter Other Flavor">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label class="input_title" for="themeCake">Theme Cake Column</label>
                                            <select class="form-control" id="themeCake">
                                                <option value="-" selected disabled>Select Theme Cake Number</option>
                                                <?php
                                                $sql = "SELECT * FROM `themecake`";
                                                $themeCakeResult = $con->query($sql);

                                                if ($themeCakeResult->num_rows > 0) {
                                                    // output data of each row
                                                    while ($themeCakeRow = $themeCakeResult->fetch_assoc()) { ?>
                                                        <option value="<?= $themeCakeRow['themeCakeID'] ?>"><?= $themeCakeRow['themeName'] ?> (#<?= $themeCakeRow['themeCakeID'] ?>)</option>
                                                <?php }
                                                } else {
                                                    echo "No Theme Cake found";
                                                }
                        ...
                        <script>
                            ...
                            function submitForm() {
                                ...
                                var signature = document.getElementById('canvasImageInput').value;
                                var themeCake = document.getElementById('themeCake').value;
                                var cupCakes = document.querySelector('input[name=cupcake]:checked').value;
                                if (cupCakes == "Yes") {
                                    var cupCakeSize = document.querySelector('input[name=cupCakeSize]:checked').value;
